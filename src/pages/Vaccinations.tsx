...
const Vaccinations: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await DatabaseService.createVaccination({
  ...
  const handleGenerateInvoice = async () => {
    ...
    try {
      ...
      const invoiceNo = await DatabaseService.generateVaccinationInvoiceNumber();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-semibold text-white" style={{ color: '#7c3b92' }}>Vaccination Module</h1>
          </div>
          <p className="text-gray-600">Record vaccination administration details</p>
        </div>
        ...
        {patient && registration && (
          <form onSubmit={handleSubmit} className="bg-white shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Vaccination Details</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  ...
                  <span>{isSubmitting ? 'Saving...' : 'Save Vaccination Record'}</span>
                </button>
              </div>
            </div>
          </form>
