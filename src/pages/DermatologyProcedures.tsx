...
const DermatologyProcedures: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await DatabaseService.createDermatologyProcedure({
        ...
        procedure_details: formData.procedureDetails || undefined
      });

      setSuccess('Dermatology procedure record saved successfully!');
  ...
  const handleGenerateInvoice = async () => {
    ...
    try {
      ...
      const invoiceNo = await DatabaseService.generateDermatologyProcedureInvoiceNumber();
      ...
      const invoice = {
        ...
        procedureDetails: formData.procedureDetails || 'N/A',
        paymentMethod: formData.paymentMethod,
        amount: Math.round(paymentAmountValue * 100) / 100,
        patient_id: patient.id,
        doctor_id: formData.doctorId,
        dermatology_procedure_id: undefined
      };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-semibold text-white" style={{ color: '#7c3b92' }}>Dermatology Procedures</h1>
          </div>
          <p className="text-gray-600">Record dermatology procedure details</p>
        </div>
        ...
        {patient && registration && (
          <form onSubmit={handleSubmit} className="bg-white shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Procedure Details</h2>
            ...
            <div className="space-y-6">
              ...
              {/* Procedure Details */}
              <div>
                <label htmlFor="procedureDetails" className="block text-sm font-medium text-gray-700 mb-2">
                  <div className="flex items-center space-x-2">
                    <FileText className="h-4 w-4 text-gray-500" />
                    <span>Procedure Details (Optional)</span>
                  </div>
                </label>
                <textarea
                  id="procedureDetails"
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  placeholder="Enter procedure details, treatment type, products used, notes, etc."
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  ...
                  <span>{isSubmitting ? 'Saving...' : 'Save Procedure Record'}</span>
                </button>
              </div>
            </div>
          </form>
