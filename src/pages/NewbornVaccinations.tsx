...
const NewbornVaccinations: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await DatabaseService.createNewbornVaccination({
        ...
        vaccination_details: formData.vaccinationDetails || undefined
      });

      setSuccess('Newborn vaccination record saved successfully!');
  ...
  const handleGenerateInvoice = async () => {
    ...
    try {
      // Peek at next invoice number (doesn't consume it - reads MAX from database)
      const invoiceNo = await DatabaseService.generateNewbornVaccinationInvoiceNumber();
      ...
      const invoice = {
        ...
        vaccinationDetails: formData.vaccinationDetails || 'N/A',
        paymentMethod: formData.paymentMethod,
        amount: Math.round(paymentAmountValue * 100) / 100,
        patient_id: patient.id,
        doctor_id: formData.doctorId,
        newborn_vaccination_id: undefined
      };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-semibold text-white" style={{ color: '#7c3b92' }}>N/B Babies Vaccination</h1>
          </div>
          <p className="text-gray-600">Record newborn baby vaccination details</p>
        </div>
        ...
        {patient && registration && (
          <form onSubmit={handleSubmit} className="bg-white shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Newborn Vaccination Details</h2>
            ...
            <div className="space-y-6">
              ...
              {/* Vaccination Details */}
              <div>
                <label htmlFor="vaccinationDetails" className="block text-sm font-medium text-gray-700 mb-2">
                  <div className="flex items-center space-x-2">
                    <FileText className="h-4 w-4 text-gray-500" />
                    <span>Vaccination Details (Optional)</span>
                  </div>
                </label>
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  placeholder="Enter vaccination details, vaccine name, batch number, notes, etc."
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  ...
                  <span>{isSubmitting ? 'Saving...' : 'Save Newborn Vaccination Record'}</span>
                </button>
              </div>
            </div>
          </form>
...
export default NewbornVaccinations;
