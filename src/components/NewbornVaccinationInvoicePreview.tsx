...
interface NewbornVaccinationInvoicePreviewProps {
  invoiceData: {
    invoiceNo: string;
    date: string;
    time: string;
    ...
    patient_id?: string;
    doctor_id?: string;
    newborn_vaccination_id?: string;
  };
  onClose: () => void;
}

const NewbornVaccinationInvoicePreview: React.FC<NewbornVaccinationInvoicePreviewProps> = ({ invoiceData, onClose }) => {
  ...
  const handleSaveInvoice = async () => {
    ...
    try {
      await DatabaseService.saveNewbornVaccinationInvoice({
        invoice_no: invoiceData.invoiceNo,
        newborn_vaccination_id: invoiceData.newborn_vaccination_id || null,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[95vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* N/B Babies Vaccination Details Table */}
          <div className="mb-3">
            <div className="bg-gray-200 border border-gray-800 px-2 py-1">
              <h3 className="text-xs font-bold text-gray-900">N/B BABIES VACCINATION DETAILS</h3>
            </div>
            <table className="w-full border-l border-r border-b border-gray-800" style={{ borderCollapse: 'collapse' }}>
              <tbody>
                <tr>
...
export default NewbornVaccinationInvoicePreview;
